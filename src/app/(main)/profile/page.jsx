      ...
      <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-8">
        ...
        <div className="mb-8 p-6 bg-gray-100 rounded-lg">
          <div className="flex items-center mb-6">
            <div className="w-24 h-24 rounded-full bg-blue-200 flex items-center justify-center border-4 border-blue-500 relative overflow-hidden">
              {session?.user.image ? (
                <Image
            ...
            <div className="ml-6">
              ...
              {/* <p className="text-sm text-gray-500 mt-2">{session?.user.date}</p> */}
            </div>
          </div>
        </div>

        {/* Update Form */}
        <form onSubmit={handleSubmit(handleProfileForm)} className="space-y-6">
          <div>
